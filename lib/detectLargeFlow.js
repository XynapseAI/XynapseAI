...
const DEFAULT_ETH_PRICE_USD = 2200;

export async function detectLargeFlow(walletAddress, chain = 'ethereum', thresholdUsd = 50000000, txLimit = 500, ethPriceUsd = DEFAULT_ETH_PRICE_USD) {
