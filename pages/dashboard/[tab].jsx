...
export default function Dashboard() {
  ...
  const handleSignInTwitter = async () => {
    try {
      await signIn('twitter', { callbackUrl: '/dashboard/leaderboard' }); // Updated callback URL
    } catch (error) {
  ...
  const handleSignOut = async () => {
    try {
      ...
      setUserData(null);
      setError(null);
      router.push('/dashboard/leaderboard'); // Redirect to /dashboard/leaderboard after sign out
    } catch (error) {
