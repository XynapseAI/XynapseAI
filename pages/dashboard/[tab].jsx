...
export default function DashboardTab() {
    ...
    const { tab } = router.query; // Get the tab from the URL
    ...
    if (status === 'unauthenticated') {
        return (
          ...
          .stars-layer-2 {
            background: url("data:image/svg+xml,%3Csvg viewBox='0 0 1200 800' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx=' moments150' cy='400' r='1.5' fill='rgba(255,255,255,0.5)'/%3E%3Ccircle cx='400' cy='200' r='2' fill='rgba(255,255,255,0.4)'/%3E%3Ccircle cx='600' cy='700' r='1' fill='rgba(255,255,255,0.3)'/%3E%3Ccircle cx='900' cy='300' r='1.5' fill='rgba(255,255,255,0.5)'/%3E%3C/svg%3E");
