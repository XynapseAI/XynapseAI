...
export default function AITab({ recaptchaRef }) {
  ...
  return (
    <motion.div
      ...
      className={`font-jetbrains w-full h-full mx-auto bg-galaxy backdrop-blur-lg shadow-glow-neon ${isMobile ? 'h-[calc(50vh)] min-h-[calc(50vh)]' : 'h-[calc(100vh)] min-h-[calc(95vh)]'} flex flex-col overflow-hidden`}
    >
      {/* Header */}
