            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-white/10">
                <input
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className={`text-white border border-white/20 bg-white/5 backdrop-blur-xl focus:outline-none focus:ring-2 focus:ring-neon-blue/50 rounded-xl ${config.modalInput}`}
                  aria-label="Search wallets, nametags, or exchanges"
                  autoFocus
                />
                <motion.button
