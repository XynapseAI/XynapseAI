                ...
                {/* {Array(5)
                  ...
                  .map((_, index) => (
                    <SkeletonLoader
                      ...
                      count={1}
                      isMobile={isMobile}
                      className="w-20 h-6 rounded-lg bg-gray-800/50 animate-pulse"
                    />
                  ))} */}
              </div>
            ) : trendingError ? (
