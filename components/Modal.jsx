            ...
            {isLoading && (
              ...
              >
                <div className="w-full h-full flex items-center justify-center">
                  <div className="w-[90%] sm:w-[90%] h-[30%] sm:h-[30%] bg-black/10 backdrop-blur-xl border border-white/20 rounded-xl p-4 relative overflow-hidden shadow-2xl animate-pulse-slow">
